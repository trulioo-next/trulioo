...
const Page = props => {
  ...
  // useSelector(state => pageDataSelector(state));
  ...
  let data =
    ...
    let seoTitle = pageData.seo.title || 'Trulioo'
    let seoDesc =  pageData.seo.desc || ''
    let seoImage = pageData.seo.facebook_image || ''
...
Page.getInitialProps = async ({ query, res, req, store }) => {
  ...
  const yoast = initalState.page.data;
