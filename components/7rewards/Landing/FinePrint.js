        ...
        <Col xs="12" md="10" lg="9" className="col">
          <Row className="text-center my-md-1 fineprint">
            <Col>
              ...
              Go to the 7-Eleven Mobile App for additional terms and conditions of 7Rewards. Points exclude
              services, fuel, and age-restricted items including tobacco and lottery.
            </Col>
          </Row>
        </Col>
      </Row>
