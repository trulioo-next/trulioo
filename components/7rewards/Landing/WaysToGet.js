    ...
    <Container className="Section__container">
      <Row className="justify-content-center text-center my-lg-5">
        <Col xs="12" md="9" lg="8" className="col">
          ...
          <p className="lead">
          When you join 7REWARDS you can earn points on every purchase and redeem those points on FREE snacks and drinks. 
          Collect extra points on select bonus point items to enjoy rewards faster. Get the 7-Eleven app and get started.
          </p>
        </Col>
      </Row>
      <Row className="justify-content-center text-center my-lg-5">
        <Col xs="12" md="9" lg="8" className="col mb-5">
          <a
