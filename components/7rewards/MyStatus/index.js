...
import RewardsBarcode from './RewardsBarcode';
  ...
  return (
    <aside className="MyStatus">
      <Row className="align-items-center">
        ...
        <Col xs="12" className="col d-md-none text-center">
          <p>Scan this barcode in the store to receive and redeem points.</p>
          <div className="px-4 mt-4">
            <RewardsBarcode data={data.barcode} />
          </div>
        </Col>
      </Row>
    </aside>
