...
const SectionBody = props => {
  ...
  return (
    <div className={bodyClasses}>
      ...
      <CheckBalanceModal visible={false} ref={ref}  content={props.modalContent} error={props.error} balance={props.balance} card={props.card}/>
    ...
    >
      ...
      <div className={classNames('container', 'Section__container')}>
        <div className={rowClasses}>
          ...
          <SectionBody data={content} modalContent={modalData} error={error} balance={cardBalance} card={userData.cardBalance}>{children}</SectionBody>
        </div>
      </div>
    </section>
  );
