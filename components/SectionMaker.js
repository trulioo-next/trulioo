...
const SectionMaker = ({
  ...
  switch (type) {
    ...
    case 'identity_verification_block':
      return (
        <IdentityVerification sectionIndex={sectionIndex} component={params} />
      );

    case 'success_stories_financial_services_block':
      return (
        <SuccessFinancial sectionIndex={sectionIndex} component={params} />
      );
    ...
    case 'multi_row_section_block':
      return (
        <MultipleRowSection sectionIndex={sectionIndex} component={params} />
      );
    ...
    case 'two_column_content_block':
      return (
        <TwoColumnContent sectionIndex={sectionIndex} component={params} />
      );
    ...
    case 'business_intelligence_block':
      return (
        <BusinessIntelligence sectionIndex={sectionIndex} component={params} />
      );
