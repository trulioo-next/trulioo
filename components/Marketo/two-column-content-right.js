...
export const TwoColumnContentRight = ({ component }) => {
  ...
  return (
    <section className="marketo-form-section section d-flex align-items-center" style={ { backgroundColor: component.background_color } }>
      ...
      <Container className="py-md-5">
        <Row className="mx-n5 justify-content-end">
          ...
          <Col xs="12" md="12" lg="12" className="col">
          ...
          <Col xs="12" md="6" lg="6" className="col">
            <Container fluid className="p-5 px-md-4">
              <form id={ `mktoForm_${ component.form_id }` } className="marketo-form mt-md-5 mt-sm-0"></form>
            </Container>
          </Col>
          <Col xs="12" md="6" lg="6" className="col">
            <Container fluid className="p-5 px-md-4">
...
TwoColumnContentRight.propTypes = {
